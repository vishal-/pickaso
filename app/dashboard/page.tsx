...
const quickActions = [
  ...
  },
  {
    ...
    desc: "Create a temporary upload token",
    icon: "🔑",
    href: "#",
  },
  {
    label: "View API Docs",
    desc: "Explore endpoints and examples",
    icon: "📄",
    href: "#",
  },
];
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {stats.map((s) => (
            <div
              key={s.label}
              className="rounded-xl border border-white/8 bg-gray-900/50 p-5 flex flex-col gap-3"
            >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/5 p-6 flex flex-col">
            ...
            <p className="text-xs text-gray-500 mb-5 leading-relaxed">
              Your workspace is ready. Follow these steps to integrate Pickaso
              into your app.
            </p>
            ...
            <a
              href="#docs"
              className="mt-6 text-xs font-semibold text-indigo-400 hover:text-indigo-300 transition-colors"
            >
              Read the docs →
            </a>
          </div>
