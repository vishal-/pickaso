...
export default function Home() {
  return (
    <div className="relative text-gray-100 overflow-x-hidden min-h-screen flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      {/* Header */}
      <header className="relative z-10 max-w-5xl mx-auto w-full px-6 py-5 flex justify-between items-center border-b border-white/5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-lg tracking-tight text-white" style={{ fontFamily: "var(--font-space-grotesk)" }}>
            Pickaso
          </span>
        </div>
        <LoginButton />
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 py-24 max-w-5xl mx-auto w-full">
        ...
        <div className="w-full max-w-4xl flex flex-col md:flex-row items-center md:items-stretch gap-6">
          <div className="flex flex-col items-center md:items-start justify-center gap-3 md:w-1/3 shrink-0">
            <a href="#docs"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 w-full max-w-4xl mt-16">
          {[
            ...
            <div key={f.title} className="p-4 rounded-xl border border-gray-800/60 bg-gray-900/30 hover:bg-gray-900/60 hover:border-indigo-500/20 transition-all duration-200 text-left">
